 ...
 */
public final class DroolsRulesLoaderLogger {
    private static final Logger LOGGER = LoggerFactory.getLogger(DroolsRulesLoaderLogger.class);

    private DroolsRulesLoaderLogger() {
    }
